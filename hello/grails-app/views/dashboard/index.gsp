    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <g:if test="${session.user.admin}">
                <g:form controller="user" action="search"  class="d-flex">
                ...
                <g:else>
                    <g:form controller="user" action="search"  class="d-flex">
                        <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" name="word" required>
                        <button class="btn btn-outline-success" type="submit">Search</button>
                    </g:form>
             ...
             <g:each in="${subList}" var="it">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <g:link controller="topic" action="deleteTopic" params="[id:it.topic.id]" onclick="return confirm('Are you sure you want to delete this item')" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                    ...
                    <g:if test="${it.createdBy.username.equals(session.user.username)}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <g:link controller="topic" action="deleteTopic" params="[id:it.id]" onclick="return confirm('Are you sure you want to delete this item')"  class="nav-link" ><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                      height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                        <path
                                                d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" />
                                        <path fill-rule="evenodd"
                    ...
                    <g:else>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-auto">
                                    <figure class="figure">
                                        <asset:image src="${it.resource.createdBy.photo}" id="fif"></asset:image>
                                ...
                                <div class="col">
                                    <div class="row">
                                        <div class="col">
                                            <h5 class="card-title">${it.resource.createdBy.firstname} ${it.resource.createdBy.lastname} <h6
                                                ...
                                                -updated ${it.resource.lastUpdated}</h6>
                                            </h5>
                                        </div>
                                        <div class="col">
                                            <div class="mb-3">
                                                <a href="#" class="link-primary"><h5>${it.resource.topic.topicname}</h5></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row"><p class="card-text">${it.resource.description}</p></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <g:if test="${it.resource.hasProperty("filePath")}">
                                            ...
                                            <div class="col-auto">
                                                <div class="mb-3">
                                                    <g:link controller="resource" action="documentFile" params="[id:it.resource.id]" class="link-primary">Download</g:link>
                                                </div>
                                            </div>
                                        </g:if>
                                        ...
                                        <g:else>
                                            <div class="col-auto">
                                                <div class="mb-3">
                                                    <a href="${it.resource.url}" class="link-primary">View Full Site</a>
                                                </div>
                                            </div>
                                        </g:else>
                                        <div class="col-auto">
                                            <div class="mb-3">
                                                <g:link controller="markread" action="markAsRead" params="[id: it.resource.id]" class="link-primary">Mark as read</g:link>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <div class="mb-3">
                                                <g:link controller="resourcerating" action="index" params="[id: it.resource.id]"  class="link-primary">View Post</g:link>
                                            </div>
                                        </div>
