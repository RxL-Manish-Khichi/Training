...
<head>
    ...
    <title>Topic Show Link sharing app</title>
    <style>
    #fif {
        width: 2cm;
        height: 2cm;
                            ...
                            <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <g:if test="${topic.subscribers.user.email.contains(session.user.email)}">
                                            <g:link controller="Subscription" action="unsubtrend" params="[id:topic.id]" class="card-link" >Unsubscribed</g:link>
                                        </g:if>
                                        <g:else>
                                            <g:link controller="Subscription" action="subscribe" params="[id:topic.id]" class="card-link" >Subscribed</g:link>
            ...
            <div class="card" id="cardd">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="row">
                                <h5 class="card-title">${it.user.firstname} ${it.user.lastname}</h5>
                                <h6 class="card-subtitle mb-2 text-muted">@${it.user.username}</h6>
                            </div>
                            <div class="row">
                                <div class="col-auto">
                                    ...
                                    <h9 class="text-muted">Subscriptions</h9>
                                    <a href="#" class="card-link">${it.user.subscriptions.size()}</a>

                                </div>
                                <div class="col">
                                    <h9 class="text-muted">Topics</h9>
                                    <a href="#" class="card-link">${it.user.topics.size()}</a>
